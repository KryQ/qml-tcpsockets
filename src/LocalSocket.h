 ...
 */
class LocalSocket : public QQuickItem {
    /* *INDENT-OFF* */
    Q_OBJECT
    /* *INDENT-ON* */
...
public:
     ...
     */
    LocalSocket(QQuickItem* parent = 0);
     ...
     * @param parent The QML parent
     */
    LocalSocket(QMLTcpSockets::QIntPtr* socketDescriptor, QQuickItem* parent = 0);
     ...
     *
     * @return Current peer name, e.g "/tcp/sock"
     */
     ...
     *
     * @param peer The new peer name, e.g "/tcp/sock"
     */
...
private:
    ...
    QLocalSocket socket;  ///< The low level socket
...
Q_DECLARE_METATYPE(QMLTcpSockets::LocalSocket*)
